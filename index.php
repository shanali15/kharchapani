	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images1/bg-01.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form   action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" class="login100-form validate-form p-b-33 p-t-5">

					<div class="wrap-input100 validate-input" data-validate = "Enter username">
						<input class="input100" type="text" name="text" placeholder="User name">
					...
					<div class="container-login100-form-btn m-t-32">
						...
						<a class="container-login100-form-btn m-t-32" href="forgetpwd.php">
						<b style="color:black">Reset Password</b>	
						</a>
					</div>
				...
				<br><br><br>
			 <span for="" style="color: white;"> Not a member yet? &nbsp</span><a class="btn btn-primary" href="signup.php" role="button" style="background-color: #0062cc; border-color: #0069d9;">Signup</a>
