        ...
        <div class="container" id="main-body">
            ...
            <div>
                <div class="row">
                    ...
                    $debit = $row2['total'];
                    $total = $credit - $debit;
                    echo '  <div class="col-md-4"> <div class="rcorners" style="margin-top: 10px; float: left;"><img src="images1/kharcha-09.png" alt="home" width="70px" height="70px"><span style="font-size:100%; color:white;">  Credit Amount: <br>  <span style="font-size:180%; color:white;">RS  ' . $credit . '</span></span></div></div>
                                <div class="col-md-4"> <div class="rcorners" style="margin-top: 10px; float: left;"><img src="images1/kharcha-09.png" alt="home" width="70px" height="70px"><span style="font-size:100%; color:white;">Debit Amount: <br><span style="font-size:180%; color:white;"> RS  ' . $debit . '</span></span></div></div>
                                <div class="col-md-4"> <div class="rcorners" style="margin-top: 10px; float: left;"><img src="images1/kharcha-09.png" alt="home" width="70px" height="70px"><span style="font-size:100%; color:white;">Remaining Amount: <span style="font-size:180%; color:white;"><br>RS   '   . $total . '</span></span></div></div>
                        ';
                    ?>
                </div>
            ...
            <div style="margin-top: 15px;">
                <div>
                    <div class="tablebg">
                        <!-- <a href="" data-toggle="modal" data-target="#updatemodal" class="btn btn-outline-danger" role="button" style=" float: left" aria-pressed="true">Out (Debit)</a> -->
                        <label for="" style=" float: left" aria-pressed="true">
                            <h4>Transactions</h4>
                        </label>
                        <table class="table table-bordered table-responsive" style="border: none; max-height:100vh; width: 100%; overflow-x: auto; overflow-y: auto; border-radius:20px;">
                            ...
                            ?>
                                    <tr>
                                        <td>
                                            <a class="btn  del_update" id="<?php echo $row['BalanceID']; ?>" href="" role="button" style="border-radius:40px/24px; background-color:#39b54a; color:white">Delete</a>
                                        </td>
                                        <td>
                                            <a href="" id="<?php echo $row['BalanceID']; ?>" class="btn btn-primary edit_sheet" role="button" style="border-radius:40px/32px; background-color:#39b54a; color:white">Edit</a>
                                        </td>
                                        <td>
                ...
                <a href="" data-toggle="modal" data-target="#updatemodal" class="btn btn-success" role="button" style=" float: left" aria-pressed="true">Out (Debit)</a>
                <a href="" data-toggle="modal" data-target="#creditmodal" class="btn btn-success" role="button" style=" float: right;" aria-pressed="true">In (Credit)</a>
            </div>
            <div>
                <?php
                // $sql1 = "SELECT SUM(BAmount) AS total FROM balancesheet WHERE BCredit=1";
