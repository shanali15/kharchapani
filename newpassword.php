	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images1/bg-01.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form   action="passwordset.php" method="POST" class="login100-form validate-form p-b-33 p-t-5">

					<div class="wrap-input100 validate-input" data-validate = "Please Paste the Key">
						<input class="input100" type="text" name="key" placeholder="Please Paste the Key">
